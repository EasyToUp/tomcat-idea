        ...
        window.onload = function () {
            document.getElementById("delSelected").onclick = function () {
                ...
                if (confirm("您确定要删除选中条目吗！")) {
                    ...
                    //     //设置cbs[i]的checked状态等于firstCb.checked
                    //     if (cbs[i].checked) {
                    //         flag = true;
                    //     }
                    // }
...
<div class="container">
    ...
    <div style="float: left;">
        <form role="form" class="form-inline" action="${pageContext.request.contextPath}/findUserByPageServlet"
              method="post">
            <div class="form-group">
                <label for="name1">姓名</label>
                <input type="text" name="name" value="${condition.name[0]}" class="form-control" id="name1">
            </div>

            <div class="form-group">
                <label for="name2">籍贯</label>
                <input type="text" name="address" value="${condition.address[0]}" class="form-control" id="name2">
            </div>

            <div class="form-group">
                <label for="name3">邮箱</label>
                <input type="text" name="email" value="${condition.email[0]}" class="form-control" id="name3">
            </div>
